...
export default function RoadmapChart({ projects, clients }: RoadmapChartProps) {
  ...
  return (
    <div className="flex flex-col gap-5 max-w-6xl">
      ...
      >
        <div style={{ minWidth: 700, padding: "16px 16px 20px" }}>
          {/* 월 헤더 */}
          <div
            style={{
              display: "grid",
          ...
          >
            ...
            {MONTHS.map((m, i) => (
              <div
                ...
                style={{
                  fontSize: 11,
                  color: i === CURRENT_MONTH ? "var(--text-primary)" : "var(--text-meta)",
                  fontWeight: i === CURRENT_MONTH ? 600 : 400,
                  paddingBottom: 6,
            ...
            {groups.length === 0 ? (
              ...
              groups.map(({ client, projects: gProjects }) => (
                <div key={client.id} className="mb-4">
                  {/* 클라이언트 헤더 */}
                  <div
                    className="flex items-center gap-1.5 mb-2 py-1"
                  ...
                  >
                    ...
                    />
                    <span style={{ fontSize: 11, fontWeight: 500, color: client.color }}>
                      {client.name}
                    </span>
                  </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          ...
                          style={{ backgroundColor: "var(--bg-surface)", zIndex: 5 }}
                        >
                          <p
                            className="truncate"
